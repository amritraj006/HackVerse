const variants = {
  primary: 'bg-indigo-600 hover:bg-indigo-700 text-white shadow-sm focus:ring-2 focus:ring-indigo-500/20',
  secondary: 'bg-slate-100 hover:bg-slate-200 text-slate-700 border border-slate-200 focus:ring-2 focus:ring-slate-400/20',
  outline: 'bg-white border border-slate-300 hover:bg-slate-50 text-slate-700 focus:ring-2 focus:ring-slate-300/30',
  danger: 'bg-rose-600 hover:bg-rose-700 text-white shadow-sm focus:ring-2 focus:ring-rose-500/20',
  ghost: 'bg-transparent hover:bg-slate-100 text-slate-600 hover:text-slate-900',
};

const sizes = {
  sm: 'px-3 py-2 text-xs rounded-lg font-semibold',
